...
{B} [{R}✔{B}] {Y}DEVELOPER  :{G} ABU RAIHAN

{B} [{R}✔{B}] {B}FACEBOOK   :{G} ABU RAIHAN 

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} [ERROR]
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/profile.php?id=100003472256152&mibextid=ZbWKwL")

def git():

    s(" os.system('xdg-open https://github.com/falto4437')")

def git():

    s("xdg-open https://github.com/falto4437")
...
def o():
    ...
    sefat(f' \x1b[1;32m{B}[{R}3{B}] \x1b[1;32m{P}FOLLOW MY GROUP')
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/groups/452215046996439/?ref=share', {
...
def i():
    ...
    s("xdg-open https://www.facebook.com/groups/452215046996439/?ref=share")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write('\r %s[RAIHAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
